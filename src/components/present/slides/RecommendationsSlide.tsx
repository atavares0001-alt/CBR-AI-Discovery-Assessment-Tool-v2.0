...
export function RecommendationsSlide({ assessment }: RecommendationsSlideProps) {
  ...
  return (
    <TwoColumnSlide
      ...
      subtitle="Strategic solutions tailored to eliminate bottlenecks and leverage automation algorithms."
      icon={
    ...
    >
      <div className="flex w-full flex-col gap-6">
        ...
        {s6.detailed_recommendations && (
          <div className="glass-card rounded-2xl px-6 py-6 sm:px-8 sm:py-7 hover:-translate-y-1 transition-transform mt-2">
            <SectionHeader
